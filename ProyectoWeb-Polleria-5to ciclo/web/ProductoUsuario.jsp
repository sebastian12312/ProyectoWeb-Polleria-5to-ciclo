            ...
            <div class="row">
                <div class="barra-lateral col-12 col-sm-auto">
                    <nav class="menu d-flex d-sm-block justify-content-center flex-wrap">
                        ...
                        <a>Usuario: Cliente</a>
                        <a href="#"><i class="fas fa-tachometer-alt"></i></i><span>DashBoard</span></a>                                              <a href="#"><i class="fas fa-utensils"></i><span>Carta de Menu</span></a>
                                ...
                                <div class="col-md-6 col-lg-4 project-box parrilla">
                                    <div class="card w-100 h-90 card-border mb-5">
                                        ...
                                        <div class="card-body text-center">
                                            ...
                                            <a href="MenuUsuario?op=producto&id" class="btn btn-danger mb-3" >Comprar</a>
                                            
                                            <a href="#" class="btn btn-info mb-3">Agregar a Carrito</a>
                                        </div>
                                    </div>
                                </div>
