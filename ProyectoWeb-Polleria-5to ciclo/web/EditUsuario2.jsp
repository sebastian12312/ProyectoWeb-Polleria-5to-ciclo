                ...
                <main class="main col">
                    <div class="row justify-content-center align-content-center text-center">
                        <div class="columna ">
                            ...
                            <form action="Usuarios2">
                                <%
                                    ArrayList<Usuario2> lista = (ArrayList<Usuario2>) request.getAttribute("lista");
                                    for (int i = 0; i < lista.size(); i++) {
                                        Usuario2 user = lista.get(i);
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" name="telefono" class="form-control" id="floatingInput" value="<%=user.getTelefono()%>" >
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" name="mensaje" class="form-control" id="floatingInput" value="<%=user.getMensaje()%>">
