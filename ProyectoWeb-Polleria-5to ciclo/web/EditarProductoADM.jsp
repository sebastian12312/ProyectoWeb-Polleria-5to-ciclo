            ...
            <div class="row">
                ...
                <main class="main col">
                    <div class="row justify-content-center align-content-center text-center">
                        <div class="columna ">
                            <h1 class="display-5">Actualizar Menu </h1>
                            <br>
                            ...
                            <form action="Menu">
                                <%
                                    ...
                                    for (int i = 0; i < lista.size(); i++) {
                                        ProductosMenu user = lista.get(i);
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" name="categoria" class="form-control" id="floatingInput" value="<%=user.getTipo()%>">
                                    <label for="floatingInput">Categoria</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="number" name="correo" class="form-control" id="floatingInput" value="<%=user.getPrecio()%>" >
                                    <label for="floatingInput">Precio</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" name="txt" class="form-control" id="floatingInput" value="<%=user.getCantidad()%>">
