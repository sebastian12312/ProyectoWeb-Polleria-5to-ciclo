                            ...
                            <br>  <br>  
                                <table class="table table-warning table caption-top " >
                                    ...
                                    <tr class="table-bordered table table-hover table-sm ">
                                        <td><%=user2.getID()%></td>
                                        <td><%=user2.getNombre()%></td>
                                         <td><%=user2.getApellido()%></td>
                                         <td><%=user2.getCorreo()%></td>                                      
                                        <td><%=user2.getTelefono()%></td>
                                         <td><%=user2.getGenero()%></td>
                                         <td><%=user2.getMensaje()%></td>
                                         <td class="boton1">
                                             <a class="boton" href="Usuarios2?op=eliminar&id=<%=user2.getID()%>" class="link-danger"><i class="far fa-trash-alt"></i></a>
                                            <a  class="boton" href="Usuarios2?op=consultarCod&id" class="link-danger"><i class="far fa-edit"></i></a>    
                                         </td>
                                    </tr>
                                    <%
                                        }
