...
<html>
 ...
 <%
                                ArrayList<Usuario1> lista = (ArrayList<Usuario1>) request.getAttribute("lista");
                                for (int i = 0; i < lista.size(); i++) {
                                    Usuario1 user = lista.get(i);
                            ...
                            %>
                                ...
                                <div class="form-floating mb-3">
                                    <input name="id" type="text" class="form-control" id="floatingInput" value="<%=user.getID()%>" readonly="enable" >
                                    <label  for="floatingInput">ID</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input name="nombre" type="text" class="form-control" id="floatingPassword" value="<%=user.getNombre()%>" >
                                    <label for="floatingPassword">Nombre</label>
                                </div>

                                <div class="form-floating mb-3">
                                    <input type="text" name="apellido" class="form-control" id="floatingInput" value="<%=user.getApellido()%>">
                                    <label for="floatingInput">Apellido</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="email" name="correo" class="form-control" id="floatingInput" value="<%=user.getCorreo()%>" >
                                    <label for="floatingInput">Correo</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="password" name="password" class="form-control" id="floatingInput" value="<%=user.getPassword()%>">
                                    <label for="floatingInput">Password</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" name="telefono" class="form-control" id="floatingInput" value="<%=user.getTelefeno()%>" >
                                    <label for="floatingInput">Telefono</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" name="genero" class="form-control" id="floatingInput" value="<%=user.getGenero()%>" >
                                    <label for="floatingInput">Genero</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" name="rango" class="form-control" id="floatingInput" value="<%=user.getRango()%>">
                                    <label for="floatingInput">Rango</label>
                                </div>
                                <div>
                                    <input  class="btn btn-primary mb-5" type="submit" name="name" value="Actualizar Usuario">
                                </div>
