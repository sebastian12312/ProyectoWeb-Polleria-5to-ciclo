                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><%=pedido.getMotorizado()%></td>
                                        <td><%=pedido.getDireccion()%></td>
                                        <td><%=pedido.getNombre_P()%></td>
                                        <td><%=pedido.getPrecio_P()%></td>
                                        <td><a class="btn btn-primary"><%=pedido.getEstado()%></a></td>                              
                                        <td><a href="Menu?op=consultar&id"><i class="fas fa-plus"></i></a></td>
