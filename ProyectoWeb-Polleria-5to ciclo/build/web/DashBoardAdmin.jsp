            ...
            <div class="row">
                <div class="barra-lateral col-12 col-sm-auto">
                    <nav class="menu d-flex d-sm-block justify-content-center flex-wrap">
                        ...
                        <a  href="Pedido?op=lista"><i class="fas fa-gift"></i><span>Pedidos</span></a>
                ...
                <main class="main col">
                    <div class="row justify-content-center align-content-center text-center">
                        <div class="columna ">
                            ...
                            <div class="igual">
                                <div>
                                    <a href="Usuarios1?op=listar"><img src="img/add-users.png" alt=""></a>
                                    <br>
                                    <p>Usuarios Registrados</p>
                                </div>
                                <div>
                                    <a href="Usuarios2?op=listar"><img src="img/anonymous-user.png" alt=""></a>  
                                    <br>
                                    <p>Usuario No Registrados</p>
                                </div>
                            </div>
                            <br><br><br><br>
                            <div class="igual">
                                <div>
                                    <a href="Menu?op=lista"><img src="img/restaurant.png" alt=""></a>
                                    <br>
                                    <p>Platos de Menus</p>
                                </div>
                                <div>
                                    <a href="Motorizado?op=listar"><img src="img/delivery-boy.png" alt=""></a>
                                    <br>
                                    <p>Usuarios Motorizados</p>
                                </div>   
                            </div>
                        </div>
                    </div>
