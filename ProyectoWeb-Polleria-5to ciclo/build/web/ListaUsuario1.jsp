                ...
                <main class="main col">
                    <div class="row justify-content-center align-content-center text-center">
                        <div class="columna ">
                            ...
                            <br>
                            <div type="button" class="btn btn-info " href="AgregarUsuario1.jsp">
                                <a href="AgregarUsuario1.jsp">Agregar Nuevo Usuario</a>
                            </div>
                            <br>  <br>  
                                <table class="table table-warning table caption-top " >
                                    ...
                                    <tr class="table-bordered table table-hover table-sm ">
                                        ...
                                        <td><%=user.getNombre()%></td>
                                         ...
                                         <td><%=user.getTelefeno()%></td>
                                         <td><%=user.getGenero()%></td>
                                         <td><%=user.getRango()%></td>
                                         <td class="boton1">
                                             <a class="boton" href="Usuarios1?op=eliminar&id=<%=user.getID()%>" class="link-danger"><i class="far fa-trash-alt"></i></a>
                                            <a  class="boton" href="Usuarios1?op=consultarCod&id" class="link-danger"><i class="far fa-edit"></i></a>    
                                         </td>
                                    </tr>
                                    <%
                                        }
